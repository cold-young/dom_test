...
class Test():
    ...
    def main(self):        
        ...
        object_usd_path = self.asset_path + "tactile_scene_23.usd"
        ...
        self.robotiq = ArticulationView(
            prim_paths_expr="/World/tactile_gripper/robotiq", name="robotiq")
        world.scene.add(self.robotiq)
        
        self.object = RigidPrimView(prim_paths_expr="/World/tactile_gripper/tactile/sensors_1/sensor_01", 
                                    name="object_view",
                                    track_contact_forces=True)
        self.object2 = RigidPrimView(prim_paths_expr="/World/tactile_gripper/tactile/sensors_1/sensor_00", 
                                    name="object_view",
                                    track_contact_forces=True)
        ...
        while simulation_app.is_running():
            ...
            if i == 2:
                ...
                reading1 = self.object.get_net_contact_forces() 
                reading2 = self.object2.get_net_contact_forces()
                print("tactile sensor :", reading1)
                i = 0
            # # # ### PD position control##
