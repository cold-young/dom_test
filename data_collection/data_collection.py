...
class DataCollection():
    ...
    def main(self):
        ...
        if args_cli.norm_pcd:
            np.save(os.path.join(self.current_directory, 'data', f'{args_cli.object}', f'{args_cli.object}_pcds_norm.npy'), dataset)
        else:
            np.save(os.path.join(self.current_directory, 'data', f'{args_cli.object}', f'{args_cli.object}_pcds.npy'), dataset)
